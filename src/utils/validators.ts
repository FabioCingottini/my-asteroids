...
export namespace Validators {
  export const nasaResponseAsteroidsApi = z.object({
    links: z.object({next: z.string(), previous: z.string(), self: z.string()}),
  ...
  export const nasaResponseAsteroidDetailApi = z.object({
    links: z.object({self: z.string()}),
    id: z.string(),
    neo_reference_id: z.string(),
    name: z.string(),
